...
sgl::PackedColour sgl::Colour::Pack(const Colour& colour)
{
	return
...
sgl::Colour sgl::Colour::Unpack(PackedColour packedColour)
{
	return Colour(
		(packedColour >> 24) & 0xFF,
...
#define SGL_INIT_COLOUR(name, hex) const sgl::Colour& sgl::Colour::name = sgl::Colour::Unpack(0x##hex##FF)
